		...
		<div class="row row-margin">
			<div class="col-sm-8 col-md-6">
			 ...
			 -->
				<div class="info-block text-leaf double-height">
					...
					<img src="images/yeti-mobile.png" data-at2x="images/yeti-mobile@2x.png" class="visible-xs hires" width="500" height="500" />
					<img src="images/yeti-tablet.png" data-at2x="images/yeti-tablet@2x.png" class="visible-sm hires" width="500" height="500" />
					<img src="images/yeti-desktop.png" data-at2x="images/yeti-desktop@2x.png" class="visible-md visible-lg hires" width="500" height="500" />
				</div>
			</div>
			...
			<div class="col-sm-4 col-md-3">
				<div class="info-block full-orange-leaf">
					<div class="orange-leaf">
						<div class="content">
							<h2 class="quote">“Working with Passion Comm was a delight.”</h2>
							<p>
			...
			<div class="col-sm-4 col-md-3 hidden-md hidden-lg">
				<div class="info-block text-leaf">
					<div class="play-button">
						<div class="text-center">
							<a href="#"><i class="fa fa-play-circle-o"></i></a>
